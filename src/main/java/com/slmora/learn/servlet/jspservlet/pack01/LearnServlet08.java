...
/**
 * This Class created for Servlet with mapping /servletlearn08
 *
 * @Author: SLMORA
 * @DateTime: 8/16/2020 3:33 PM
 * <p>
 ...
 */
@WebServlet(
        description = "This is a simple servlet for ServletLearn08",
        urlPatterns = "/servletlearn08"
)
public class LearnServlet08 extends HttpServlet
{
    private static final long serialVersionUID = 1L;
    static final Logger LOGGER = LogManager.getLogger(LearnServlet08.class);
...
//        super.doPost(req, resp);
        LOGGER.info("Test doPost Method in LearnServlet08");
        ...
        out.println("<h1> Hi This is LearnServlet08</h1>");
        out.println("<hr>");
