<%--
* This index.jsp created for MoraServletJSPLearn015 Project
*
* @Author: SLMORA
* @DateTime: 9/5/2020 11:15 AM
* <p>
...
<main role="main">
    ...
    <div class="container marketing">
        ...
        <h3> Servlet Config Init User Name : <%=config.getInitParameter("defaultUser")%></h3>
        <h3> Servlet Config Init User Name : <%=getServletConfig().getInitParameter("defaultUser")%></h3>
