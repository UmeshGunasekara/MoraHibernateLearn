<%--
* This index.jsp created for MoraServletJSPLearn018 Project
*
* @Author: SLMORA
...
<form class="form-signin" action="${context}/signin2" method="POST">
    <img class="mb-4" src="${context}/resources/image/ClipartKey.png" alt="" width="72" height="72">
