...
<%--        <jsp:useBean id="user" class="com.slmora.learn.model.User" scope="request">--%>
<%--            <jsp:setProperty name="user" property="firstName" value="Mora"></jsp:setProperty>--%>
<%--        </jsp:useBean>--%>
        <jsp:useBean id="user" class="com.slmora.learn.model.User" scope="request"></jsp:useBean>
<%--        <%--%>
...
<%--        %>--%>
        ...
        <h3> Hello! <jsp:getProperty name="user" property="firstName"/> <jsp:getProperty name="user" property="lastName"/></h3>
